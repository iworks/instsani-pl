...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) :
		...
		<h2 class="comments-title">
			<?php
			$instsani_pl_comment_count = get_comments_number();
			if ( '1' === $instsani_pl_comment_count ) {
				printf(
					/* translators: 1: title. */
					esc_html__( 'One thought on &ldquo;%1$s&rdquo;', 'instsani-pl' ),
		...
		if ( ! comments_open() ) :
			?>
			<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'instsani-pl' ); ?></p>
			<?php
		endif;
