...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$instsani_pl_description = get_bloginfo( 'description', 'display' );
			if ( $instsani_pl_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $instsani_pl_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
